...
public class GameState : ISerializable, IDeserializable
{
    ...
    public void Serialize(IWriter writer)
    {
        ...
        writer.WriteValue(Game.time);
        writer.WriteValue(Game.Instance.tickCount);
    ...
    public void Deserialize(IReader reader)
    {
        ...
        Game.time = reader.ReadValue<int>();
        Game.Instance.tickCount = reader.ReadValue<int>();
        ...
        player = levels.Select(l => l.GamePlayer).NotNull().FirstOrDefault();
    }
