...
public record class Tile
{
    ...
    public static readonly Tile PlankFloorTile = new PlankFloorTile(25);
    public static readonly Tile PlankTile = new PlankTile(23);
    public static readonly Tile Door = new DoorTile(24);
    ...
    public virtual bool Interact(Level level, int xt, int yt, GamePlayer player, Item item, Direction attackDir)
    {
        return false;
    }
