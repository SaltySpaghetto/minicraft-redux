...
public class Item : IListItem, ISerializable, IDeserializable
{
    ...
    public virtual bool Interact(GamePlayer player, Entity entity, Direction attackDir)
    {
        return false;
    }
    ...
    public virtual bool InteractOn(Tile tile, Level level, int xt, int yt, GamePlayer player, Direction attackDir)
    {
        return false;
    }
